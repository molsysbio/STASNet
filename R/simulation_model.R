...
#' @param targets A matrix of perturbations to simulate, as generated by \link{getCombinationMatrix}. This is a matrix filled with 0 and 1, each row is a perturbation set, column names are used to determine the name of the perturbation.
...
#' @return A matrix in a MIDAS measure-like format
