...
#' @return A list that represents a MIDAS measure-like format with fields 'conditions' which is the matrix of perturbations provided as 'targets', 'bestfit' which is the simulation, and 'variants' which is a list of simulations for the alternative parameter sets from profile likelihood
...
plotModelSimulation <- function(prediction, log_axis=F) {
    if (log_axis) {
        ylog = "y"
    } else {
        ylog = ""
